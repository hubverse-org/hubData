...
This outlines how to propose a change to `hubData`. For more general
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("hubverse-org/hubData", fork = TRUE)`.
...
Please note that the hubData project is released with a [Contributor
Code of
Conduct](https://hubverse-org.github.io/hubData/dev/CODE_OF_CONDUCT.md).
