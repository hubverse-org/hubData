...
The hubData package is part of the [hubverse](https://hubverse.org) ecosystem, which aims to provide a suite of tools for infectious disease modeling and data analysis.
...
Learn more about how to [get involved in the Hubverse Community](https://hubdocs.readthedocs.io/en/latest/overview/contribute.html) or [how to contribute to the hubData package](.github/CONTRIBUTING.md).
